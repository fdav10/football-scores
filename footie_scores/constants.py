...
[{'id': '1005', 'name': 'UEFA Champions League', 'region': 'International'},
 ...
 {'id': '1199', 'name': 'EFL Cup', 'region': 'England'},
 ...
 {'id': '1265', 'name': 'Serie B', 'region': 'Italy'},
 ...
 {'id': '1425', 'name': 'Süper Lig', 'region': 'Turkey'},
 {'id': '1428', 'name': 'Premier League', 'region': 'Ukraine'},
 {'id': '1457', 'name': 'Premier League', 'region': 'Russia'}]
'''

LIMITED_COMPS = (1005, 1204, 1399)

MAJOR_COMPS = (
    1005, 1007, 1204, 1221, 1229, 1269,
    1399, 1397, 1205, 1198, 1199
    )

MOST_COMPS = (
    1005, 1007, 1102, 1198, 1199, 1204, 1205, 1221,
    1229, 1269, 1322, 1352, 1397, 1399, 1408, 1425,
    )

ALL_COMPS = (1005, 1007, 1093, 1102, 1184, 1198, 1199,
